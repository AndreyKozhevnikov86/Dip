...
public class DataHelper {
    ...
    public static String generateInvalidHolderWithCyrillicSymbols35() {
        return fakerWithCyrillicLocale.name().firstName().toUpperCase() + 35 + " "
                + fakerWithCyrillicLocale.name().lastName().toUpperCase() + 75;
    }
